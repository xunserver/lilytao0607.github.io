...
export const courses = {
  ...
  seoTitle: {
    ...
    de: 'Tai-Chi-Kurse – Beginnen Sie Ihre Reise',zh: '太极课程 - 开启您的和谐之旅',
  },
  description: {
    ...
    de: 'Entdecken Sie unsere Tai Chi-Kurse für Anfänger und Fortgeschrittene. Lernen Sie Tai Chi in den Formen 24, 42 und 108 von erfahrenen Lehrern.',zh: '探索我们的太极课程，适合初学者和进阶练习者。从经验丰富的教练那里学习24式、42式和108式太极。',
  },
  private: {
    nl: 'Privélessen',
    en: 'Private Lessons',
    de: 'Privatunterricht',zh: '私教课程',
  },
  register: {
  ...
  hero: {
    tag: {
      ...
      de: 'Professioneller Unterricht',zh: '专业教学',
    },
    title: {
      nl: 'Cursusinschrijving',
      en: 'Course Registration',
      de: 'Kursanmeldung',zh: '课程报名',
    },
    subtitle: {
      ...
      de: 'Professionelle Tai Chi Chuan-Anleitung, die Ihnen hilft, die Weisheit der Harmonie zwischen Körper und Geist zu erlernen',zh: '专业太极拳指导，助您掌握身心和谐之智慧',
    },
  },
  // 课程卡片
  cards: {
    beginner: {
      tag: {
        nl: 'Beginnerscursus',
        en: 'Beginner Course',
        de: 'Anfängerkurs',zh: '入门课程',
      },
      title: {
        nl: 'Beginners Tai Chi',
        en: 'Beginner Tai Chi',
        de: 'Tai Chi für Anfänger',zh: '初级太极课程',
      },
      duration: {
        nl: '60 min/les',
        en: '60 min/class',
        de: '60 Min./Klasse',zh: '60分钟/课时',
      },
      outline: {
        nl: 'Bekijk cursusoverzicht',
        en: 'View Outline',
        de: 'Gliederung anzeigen',zh: '查看课程',
      },
    },
    intermediate: {
      tag: {
        ...
        de: 'Mittelstufe',zh: '进阶课程',
      },
      title: {
        nl: 'Gevorderd Tai Chi',
        en: 'Intermediate Tai Chi',
        de: 'Fortgeschrittenes Tai Chi',zh: '中级太极课程',
      },
      duration: {
        nl: '60 min/les',
        en: '60 min/class',
    ...
    advanced: {
      tag: {
        ...
        en: 'Advanced Course',
        de: 'Fortgeschrittenenkurs',zh: '高级课程',
      },
      title: {
        nl: 'Traditioneel Tai Chi',
        en: 'Traditional Tai Chi',
        de: 'Traditionelles Tai Chi',zh: '高级太极课程',
      },
      duration: {
        nl: '90 min/les',
        en: '90 min/class',
        de: '90 Min./Klasse',zh: '90分钟/课时',
      },
      outline: {
        nl: 'Bekijk cursusoverzicht',
        en: 'View Outline',
  ...
  pricing: {
    ...
    workshop: {
      ...
      de: 'Die Workshops werden zu unterschiedlichen Zeiten und Orten bekannt gegeben',zh: 'Workshop会根据不同时间和地点进行通知',
    },
  },
  workshopsSection: {
    title: {
      ...
      de: 'Workshops und Unternehmenserlebnisse',zh: '工作坊与企业体验',
    },
    subtitle: {
      nl: '短期焕活体验 · 直接服务企业与团队 · 全程零基础友好',
      en: 'Short-format revitalizing sessions for teams and organizations—fully beginner friendly.',
      de: 'Revitalisierungssitzungen im Kurzformat für Teams und Organisationen – absolut anfängerfreundlich.',zh: '短期焕活体验 · 面向企业与团队 · 全程零基础友好',
    },
    items: {
      corporate: {
        tag: {
          ...
          de: 'Firmenwellness',zh: '企业焕活',
        },
        title: {
          nl: '企业活力焕新工作坊',
          en: 'Corporate Wellness Workshop',
          de: 'Corporate Wellness-Workshop',zh: '企业活力焕新工作坊',
        },
        desc: {
          nl: '1.5–2 小时的太极体验，帮助团队释放压力、恢复专注与协作。',
          en: 'A 1.5–2 hour Tai Chi session that relieves stress and recharges teams instantly.',
          de: 'Eine 1,5–2-stündige Tai-Chi-Sitzung, die Stress abbaut und Teams sofort wieder auflädt.',zh: '1.5–2 小时太极体验，帮助团队释放压力、恢复专注与协作。',
        },
        duration: '1.5–2h',
        cta: {
          nl: '查看详情',
          en: 'View Details',
          de: 'Details anzeigen',zh: '查看详情',
        },
      },
      advanced: {
        tag: {
          nl: 'Workshop II',
          en: 'Workshop II',
          de: 'Workshop II',zh: 'Workshop II',
        },
        title: {
          nl: '高级太极专业提升工作坊',
          en: 'Advanced Tai Chi Professional Intensive',
          de: 'Fortgeschrittener Tai Chi Professional Intensivkurs',zh: '高级太极专业提升工作坊',
        },
        desc: {
          nl: '2–3 周高密度训练，拳架、身法、推手与教学全方位提升。',
          en: 'A 2–3 week immersive program that upgrades forms, body method, push hands, and teaching.',
          de: 'Ein 2–3-wöchiges immersives Programm, das Formen, Körpertechnik, Push-Hands und Unterricht verbessert.',zh: '2–3 周高密度训练，拳架、身法、推手与教学全方位提升。',
        },
  ...
  features: {
    tag: {
      ...
      en: 'Why Choose Us',
      de: 'Warum sollten Sie sich für uns entscheiden?',zh: '选择我们',
    },
    title: {
      nl: 'Cursuskenmerken',
      en: 'Course Features',
      de: 'Kursfunktionen',zh: '课程特色',
    },
    items: {
      professional: {
        title: {
          ...
          de: 'Professionelle Ausbilder',zh: '专业师资',
        },
        desc: {
          nl: 'Tai Chi meesters met jaren van onderwijservaring',
          en: 'Tai Chi masters with years of teaching experience',
          de: 'Tai-Chi-Meister mit langjähriger Unterrichtserfahrung',zh: '拥有多年教学经验的太极拳师',
        },
      },
      smallClass: {
        title: {
          ...
          en: 'Small Class Size',
          de: 'Kleine Klassengröße',zh: '小班教学',
        },
        desc: {
          ...
          de: 'Der Unterricht in kleinen Klassen stellt sicher, dass jeder Schüler angemessene Anleitung und Aufmerksamkeit erhält',zh: '小班制教学，确保每位学员都能得到充分的指导和关注',
        },
      },
      flexible: {
        title: {
        ...
        desc: {
          ...
          de: 'Mehrere Zeitfenster verfügbar, an Wochentagen abends und am Wochenende, um unterschiedlichen Bedürfnissen gerecht zu werden',zh: '多个时间段可选，工作日晚上、周末均有课程，满足不同需求',
        },
      },
      environment: {
        title: {
        ...
        desc: {
          ...
          de: 'Bei gutem Wetter wählen wir möglichst Parks mit ruhiger Umgebung und frischer Luft, ideal für die Tai-Chi-Übung',zh: '天气好的情况下，尽量选择公园内，环境清幽空气清新，适合太极拳练习',
        },
      },
    },
    experienceBadge: {
  ...
  registration: {
    ...
    title: {
      ...
      de: 'Beginnen Sie Ihre Tai-Chi-Reise',zh: '开启您的太极之旅',
    },
    subtitle: {
      ...
      de: 'Füllen Sie das Anmeldeformular rechts aus und unser Kursberater wird sich innerhalb von 24 Stunden mit Ihnen in Verbindung setzen, um Ihnen den am besten geeigneten Kurs zu empfehlen.',zh: '填写右侧报名表单，我们的课程顾问将在24小时内与您联系，推荐最合适的课程。',
    },
    hours: {
      nl: '24 uur',
      en: '24 hours',
      de: '24 Stunden',zh: '24小时',
    },
    schedule: {
      title: {
        nl: 'Lesrooster',
        en: 'Class Schedule',
        de: 'Stundenplan',zh: '课程时间',
      },
      flexTitle: {
        nl: 'Flexibele Planning',
        en: 'Flexible Scheduling',
        de: 'Flexible Terminplanung',zh: '灵活安排',
      },
      desc: {
        ...
        de: 'Nach der Anmeldung stimmt sich unser Kursberater mit Ihnen ab, um die am besten geeigneten Unterrichtszeiten basierend auf Ihren Bedürfnissen und Ihrer Verfügbarkeit zu ermitteln. Wir bieten mehrere Zeitfenster an, einschließlich Wochentagen und Wochenenden.',zh: '报名后，我们的课程顾问会根据您的需求和可用时间与您协调确定最合适的上课时间。我们提供多个时间段，包括工作日和周末。',
      },
    },
    pricing: {
      title: {
      ...
      flexTitle: {
        ...
        de: 'Individuelle Preise',zh: '按需定价',
      },
      desc: {
        ...
        de: 'Die Kursgebühren richten sich nach der Kursart, der Anzahl der Sitzungen und anderen Faktoren. Nach der Anmeldung informiert Sie unser Berater ausführlich über die Preise und empfiehlt Ihnen das für Sie am besten geeignete Kurspaket.',zh: '课程费用根据课程类型、课时长短等因素确定。报名后，我们的顾问将提供详细的收费信息并为您推荐最合适的课程套餐。',
      },
    },
    contact: {
      title: {
  ...
  faq: {
    ...
    title: {
      ...
      de: 'Häufig gestellte Fragen',zh: '常见问题',
    },
    q1: {
      question: {
        nl: 'Ik heb geen ervaring. Kan ik Tai Chi leren?',
        en: 'I have zero experience. Can I learn Tai Chi?',
        de: 'Ich habe null Erfahrung. Kann ich Tai Chi lernen?',zh: '我没有任何基础，可以学太极拳吗？',
      },
      answer: {
    ...
    q2: {
      question: {
        ...
        de: 'Welche Ausrüstung benötige ich für den Kurs?',zh: '上课需要什么装备？',
      },
      answer: {
    ...
    q3: {
      question: {
        ...
        de: 'Was passiert, wenn ich den Kurs nicht in einem Semester absolvieren kann?',zh: '如果一个学期学不会怎么办？',
      },
      answer: {
        ...
        de: "Mach dir keine Sorge! Unser Kursdesign berücksichtigt den Lernfortschritt der meisten Menschen. Wenn Sie nach Abschluss eines Semesters mehr Übung benötigen, können Sie den Kurs auf demselben Niveau in einem neuen Semester wiederholen (mit Voranmeldung).",zh: '别担心！我们的课程设计考虑了大多数人的学习进度。如果您完成一个学期后还需要更多练习，可以在新学期重复同等级课程（需提前预约）。',
      },
    },
    q4: {
      question: {
        ...
        de: 'Gibt es eine Altersgrenze?',zh: '有年龄限制吗？',
      },
      answer: {
  ...
  cta: {
    title: {
      ...
      de: 'Registrieren Sie sich jetzt und starten Sie Ihr gesundes Leben',zh: '立即报名，开启健康生活',
    },
    subtitle: {
      nl: 'Vul het formulier in, en wij nemen spoedig contact met u op',
      en: 'Fill out the form, and we will contact you soon',
      de: 'Füllen Sie das Formular aus und wir werden uns in Kürze bei Ihnen melden',zh: '填写表单，我们将尽快与您联系',
    },
    button: {
      nl: 'Nu Inschrijven',
      en: 'Register Now',
